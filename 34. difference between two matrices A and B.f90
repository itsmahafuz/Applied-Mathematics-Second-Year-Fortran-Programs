!Write a Fortran program, which reads two matrices and print their subtraction in matrix form.

! This program calculates the difference between two matrices A and B.
